...
FILE_PATH_TO_SAVE_MODEL = "./weights/model_bert_with_tags_together_contras.pth"
CHECKPOINT_MODEL_PATH = "./weights/model_bert_with_tags_together_contras_checkpoint.pth" 
