...
def main():
    ...
    model = SiameseNNBatchSep(checkpoint)
    ...
    if PLOT_LOSS_AND_ACC:
        plot_loss_accuracy(train_losses, train_accuracies, "Train", "Bert (with tags) (separate)")
        plot_loss_accuracy(eval_losses, eval_accuracies, "Eval", "Bert (with tags) (separate)")
