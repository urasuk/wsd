...
FILE_PATH_TO_SAVE_MODEL = "./weights/model_bert_with_tags_together.pth"
...
def main():
    ...
    if PLOT_LOSS_AND_ACC:
        plot_loss_accuracy(train_losses, train_accuracies, "Train", "Bert (with tags) (together)")
        plot_loss_accuracy(eval_losses, eval_accuracies, "Eval", "Bert (with tags) (together)")
