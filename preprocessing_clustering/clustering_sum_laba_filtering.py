...
output_file_path = "data/final_results/clust_sum14_filtered.json"
...
def remove_non_ukrainian_symbols(input_string):
    allowed_symbols = set("́-")  # Acute accent and hyphen are allowed # date: 28.04.2024 🔥🔥🔥🔥🔥🔥🔥
...
def filter_entry(entry):
    ...
    # lemma_acute_removed = entry['lemma'] 
